    ...
    <div class="container mx-auto px-4 relative z-10">
      <div class="text-center animate-on-scroll">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <a href="https://wa.me/5547989141108?text=Olá Guitierry! Gostaria de falar sobre investimentos imobiliários no litoral catarinense." target="_blank" class="group bg-white text-primary-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
