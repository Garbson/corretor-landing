...
<template>
  ...
  >
    ...
    <div class="absolute inset-0 opacity-5">
      <div
        class="absolute top-0 right-0 w-96 h-96 bg-primary-500 rounded-full blur-3xl"
      ></div>
      <div
        class="absolute bottom-0 left-0 w-96 h-96 bg-accent-500 rounded-full blur-3xl"
      ></div>
    </div>
      ...
      <div class="grid md:grid-cols-3 gap-12 mb-12">
        ...
        <div>
          ...
          <div class="flex space-x-4">
            ...
            <a
              href="https://instagram.com/guitierrymariano"
              target="_blank"
              rel="noopener noreferrer"
              class="w-10 h-10 rounded-full bg-white/10 hover:bg-accent-600 flex items-center justify-center transition-all hover:scale-110"
            >
        ...
        <div>
          ...
          <div class="space-y-3 text-gray-300">
            <div class="flex items-start space-x-3">
              <svg
                class="w-5 h-5 mt-1 flex-shrink-0 text-accent-400"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <div class="flex items-center space-x-3">
              <svg
                class="w-5 h-5 flex-shrink-0 text-accent-400"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
